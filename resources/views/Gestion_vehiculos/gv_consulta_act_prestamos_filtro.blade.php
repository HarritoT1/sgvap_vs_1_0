...
@section('content')
    <div class="w-100 my-3 div-main">
        <h1 class="fw-bold my-3" style="font-size: 1.8rem; text-align:justify">Llena el formulario para obtener el resultado de diferentes prestamos vehículares:
        </h1>
        ...
        <div class="w-100 div-secondary px-5 py-4 d-block">
            ...
            <form id="consultar_disp_gasolina_filtro" action="#" method="get" enctype="application/x-www-form-urlencoded"
                ...
                <div class="row g-3">
                    ...
                    <div class="col-sm-6" style="max-width: 100%;" id="campo_status">
                        <label for="status" class="form-label fw-bold" style="font-size: 1.2rem;">Estado del prestamo</label>
                    ...
                    <div class="col-sm-6" style="max-width: 100%;" id="campo_rfc">
                        <label for="input_find_rfc" class="form-label fw-bold" style="font-size: 1.2rem;">RFC del empleado títular</label>
                        <input type="text" class="form-control" id="input_find_rfc" name="employee_id" placeholder=""
                            value="" maxlength="50" list="sugerencias_rfc" style="height: 3.5rem;">
                        <div class="invalid-feedback">
                    ...
                    <div class="col-sm-6" style="max-width: 100%;" id="campo_mes">
                        <label for="mes" class="form-label fw-bold" style="font-size: 1.2rem;">Mes del prestamo</label>
