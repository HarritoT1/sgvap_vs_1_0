...
@section('content')
    <div class="w-100 my-3 div-main">
        <h1 class="fw-bold my-3" style="font-size: 2rem; text-align:justify">Datos del cliente con el RFC: $id
        </h1>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="text" class="form-control" id="razon_social" name="razon_social" placeholder=""
                            value="" required maxlength="200" disabled>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control" id="ubicacion" name="ubicacion" placeholder=""
                            value="" required maxlength="300" disabled>
                        <div class="invalid-feedback">
