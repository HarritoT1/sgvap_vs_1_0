...
@section('content')
    <div class="w-100 my-3 div-main">
        <h1 class="fw-bold my-3" style="font-size: 2rem; text-align:justify">Captura los datos para generar el corte mensual
            del empleado: {{ $employee->nombre }}.</h1>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-sm-6" style="max-width: 100%;">
                        ...
                        <input type="number" class="form-control rounded-3" id="anio" name="anio" placeholder="2025"
                            step="1" min="2000" max="2150" value="{{ $anio }}" required style="height: 3.5rem;" readonly>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-sm-6" style="max-width: 100%;">
                        ...
                        <input type="text" class="form-control rounded-3" id="input_find_rfc" name="employee_id"
                            placeholder="" value="{{ $employee->id }}" required maxlength="50" list="sugerencias_rfc"
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control" aria-label="Amount (to the nearest dollar)"
                                id="total_alimentos_mes" name="total_alimentos_mes" placeholder="0.000" step="any"
                                value="{{ $total_alimentos_mes }}" required style="height: 3.5rem;" readonly> 
                            <div class="invalid-feedback">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="input-group">
                            <span class="input-group-text">$</span>
                            <input type="number" class="form-control" aria-label="Amount (to the nearest dollar)"
                                id="total_traslado_local_mes" name="total_traslado_local_mes" placeholder="0.000" step="any"
                                value="{{ $total_traslado_local_mes }}" required style="height: 3.5rem;" readonly> 
                            <div class="invalid-feedback">
                                Ingresa un monto válido.
                            </div>
                        </div>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="input-group">
                            <span class="input-group-text">$</span>
                            <input type="number" class="form-control" aria-label="Amount (to the nearest dollar)"
                                id="total_traslado_externo_mes" name="total_traslado_externo_mes" placeholder="0.000" step="any"
                                value="{{ $total_traslado_externo_mes }}" required style="height: 3.5rem;" readonly> 
                            <div class="invalid-feedback">
                                Ingresa un monto válido.
                            </div>
                        </div>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="input-group">
                            <span class="input-group-text">$</span>
                            <input type="number" class="form-control" aria-label="Amount (to the nearest dollar)"
                                id="total_comision_bancaria_mes" name="total_comision_bancaria_mes" placeholder="0.000" step="any"
                                value="{{ $total_comision_bancaria_mes }}" required style="height: 3.5rem;" readonly> 
                            <div class="invalid-feedback">
                                Ingresa un monto válido.
                            </div>
                        </div>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="input-group">
                            <span class="input-group-text">$</span>
                            <input type="number" class="form-control" aria-label="Amount (to the nearest dollar)"
                                id="total_comision_sivale_mes" name="total_comision_sivale_mes" placeholder="0.000" step="any" min="0"
                                value="" style="height: 3.5rem;"> 
                            <div class="invalid-feedback">
                                Ingresa un monto válido.
                            </div>
                        </div>
                    ...
                    <div class="col-sm-6 mx-auto">
                        ...
                        <div class="input-group">
                            <span class="input-group-text">$</span>
                            <input type="number" class="form-control" aria-label="Amount (to the nearest dollar)"
                                id="total_iva_mes" name="total_iva_mes" placeholder="0.000" step="any" min="0"
                                value="" style="height: 3.5rem;"> 
                            <div class="invalid-feedback">
                                Ingresa un monto válido.
                            </div>
