...
@section('content')
    <div class="w-100 my-3 div-main">
        <h1 class="fw-bold my-3" style="font-size: 1.8rem; text-align:justify">Llena el formulario para obtener el resultado de diferentes dispersiones de gasolina:
        </h1>
        ...
        <div class="w-100 div-secondary px-5 py-4 d-block">
            ...
            <form id="consultar_disp_gasolina_filtro" action="#" method="get"
