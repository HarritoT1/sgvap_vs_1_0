...
@section('content')
    <div class="w-100 my-3 div-main">
        <h1 class="fw-bold my-3" style="font-size: 1.8rem; text-align:justify">Llena el formulario para obtener el resultado de diferentes dispersiones de caseta:
        </h1>
        ...
        <div class="w-100 div-secondary px-5 py-4 d-block">
            ...
            <form id="consultar_disp_caseta_filtro" action="#" method="get"
                ...
                <div class="row g-3">
                    <div class="col-sm-6" style="max-width: 100%;" id="campo_mes">
                        <label for="mes" class="form-label fw-bold" style="font-size: 1.2rem;">Mes de dispersión</label>
                    ...
                    <button class="d-block mx-auto btn btn-primary btn-lg fw-bold button-custom" type="button"
                        onclick="get_results_and_show_them_like_links('/caseta_disp_consulta_filtro', 'caseta')" style="background-color: var(--botones-color);">Consultar</button>
            </form>
        </div>
    </div>
    ...
    <div class="w-100 div-secondary px-1 py-5 d-block" id="div_resultados" style="position: relative; height: 30rem;">
        ...
        <ul class="flex-column vineta d-none" style="text-align:justify; overflow-y: auto; overflow-x: hidden; height: 22rem; padding-right: 2rem;" id="lista_resultados"></ul>
    </div>
@endsection
