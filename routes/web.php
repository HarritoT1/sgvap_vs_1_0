...
Route::middleware(['auth', 'inactive'])->group(function () {
    ...
    Route::get('1', function () {return view('Gestion_dispersiones_monetarias/gdm_graficas_caseta');}); //http://127.0.0.1:8000/1
    Route::get('2', function () {return view('Gestion_dispersiones_monetarias/gdm_graficas_hospedaje');}); //http://127.0.0.1:8000/2
